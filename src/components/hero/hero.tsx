...
const HeroSection = () => {
  return (
    <>
      ...
      <div className=" bg-[#F4E2D8] h-full pb-12 w-full md:w-full ">
        <div className="flex-col flex md:flex-row w-full px-[50px] md:items-end pb-[50px] pt-[50px] gap-10 lg:gap-40">
          <div className="text-[42px] md:text-[80px] text-wrap mt-[50px] pt-4 md:pt-10 leading-tight  w-full md:max-w-[960px] font-bold">
            {" "}
          ...
          <div className="w-[200px] md:pt-[25]">
            ...
            <ul className=" text-[32px] md:text-[42px] ">
              <li>Architecture.</li>
              <li>Design.</li>
              <li>Planning.</li>
            </ul>
