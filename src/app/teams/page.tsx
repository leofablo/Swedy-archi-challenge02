...
const Page = () => {
  return (
    ...
    <div className='pt-[80px] px-[50px]'>
        <div className='md:grid md:grid-cols-2 pt-[50px] justify-start gap-4'>
            <h1 className='text-[32px] font-bold md:w-1/2 mb-10'>Meet the visionaries behind Swedy Archei.</h1>
