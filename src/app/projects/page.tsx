  ...
  return (
    <div>
      ...
      <div className='md:grid grid-cols-2 top-10 px-[50px] justify-between items-start mb-[50px]'>
        <h1 className='text-[32px] md:w-full mb-4 leading-10'> 
